...
import org.linlinjava.litemall.core.util.CacheManager;
...
public class WxHomeController {
    ...
    public Object index(@LoginUser Integer userId) {
        //优先从缓存中读取
        if (cacheManager.hasData(CacheManager.INDEX)) {
            Map<String, Object> cacheData = cacheManager.getHomeCacheData(CacheManager.INDEX);
        ...
        try {
            ...
            //缓存数据
            cacheManager.saveData(CacheManager.INDEX, entity);
        }
        catch (Exception e) {
